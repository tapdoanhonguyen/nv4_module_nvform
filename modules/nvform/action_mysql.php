...
$sql_create_module[] = "CREATE TABLE " . $db_config['prefix'] . "_" . $lang . "_" . $module_data . "(
  ...
  image varchar(250) NOT NULL COMMENT 'Hình ảnh',
  ...
  groups_view varchar(250) DEFAULT '' COMMENT 'Nhóm được xem',
...
$sql_create_module[] = "CREATE TABLE " . $db_config['prefix'] . "_" . $lang . "_" . $module_data . "_question(
  ...
  question_type enum('number','date','time','textbox','textarea','editor','select','radio','checkbox','multiselect','grid', 'grid_row','table','file','plaintext') NOT NULL DEFAULT 'textbox',
